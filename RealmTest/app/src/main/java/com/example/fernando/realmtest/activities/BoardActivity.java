...
import com.example.fernando.realmtest.adapters.BoardAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showAlertForCreatingBoard("Add new Board", "Type your board name");
            }
        });
        ...
        builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (boardName.length()==0)
                    ...
                    Toast.makeText(getApplicationContext(), "The name is the same of the current Board", Toast.LENGTH_SHORT).show();
                else
